...
const UserSideBar: React.FC<Props> = ({ serverId }) => {
  ...
  useEffect(() => {
    ...
    >({
      ...
      updateQuery: (prev, { subscriptionData }) => {
        ...
        return Object.assign({}, prev, { usersOnServer: mergedServerUsers });
      },
    });
    ...
    >({
      ...
      updateQuery: (prev, { subscriptionData }) => {
        ...
        console.log(updatedServerUsers);
        return Object.assign({}, prev, { usersOnServer: updatedServerUsers });
      },
    });
  ...
  return (
    <div className="hidden sm:flex absolute right-0 top-0" key={serverId}>
